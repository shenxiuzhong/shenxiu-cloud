...
import site.shenxiu.common.core.constant.Constants;
...
import site.shenxiu.system.domain.SysRoleMenu;
import site.shenxiu.system.domain.vo.MetaVo;
import site.shenxiu.system.domain.vo.RouterVo;
import site.shenxiu.system.mapper.SysMenuMapper;
import site.shenxiu.system.mapper.SysRoleMapper;
import site.shenxiu.system.mapper.SysRoleMenuMapper;
...
//        }
    ...
    public Set<String> selectMenuPermsByUserId(Long userId) {
        List<String> perms =null;// baseMapper.selectMenuPermsByUserId(userId);
    ...
    public Set<String> selectMenuPermsByRoleId(Long roleId) {
        List<String> perms = null;// baseMapper.selectMenuPermsByRoleId(roleId);
        Set<String> permsSet = new HashSet<>();
        for (String perm : perms) {
            if (StringUtils.isNotEmpty(perm)) {
                permsSet.addAll(Arrays.asList(perm.trim().split(",")));
...
//        }
    ...
    public List<Long> selectMenuListByRoleId(Long roleId) {
        ...
        return null;// baseMapper.selectMenuListByRoleId(roleId, role.getMenuCheckStrictly());
    }
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            List<SysMenu> cMenus =null;//  menu.getChildren();
            if (!cMenus.isEmpty() && SystemConstants.TYPE_DIR.equals(menu.getMenuType())) {
...
//                        .setWeight(menu.getOrderNum()));
    ...
    public boolean isInnerLink(SysMenu menu) {
        return menu.getIsFrame().equals(SystemConstants.NO_FRAME);
       // return menu.getIsFrame().equals(SystemConstants.NO_FRAME) && StringUtils.ishttp(menu.getPath());
    }
    ...
    public boolean isParentView(SysMenu menu) {
        return menu.getParentId().intValue() != 0 && SystemConstants.TYPE_DIR.equals(menu.getMenuType());
    }
